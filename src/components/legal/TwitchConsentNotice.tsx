...
export function TwitchConsentNotice() {
  return (
    <div className="mt-4 text-center text-[10px] sm:text-xs text-white/50 leading-relaxed max-w-sm mx-auto">
      Продолжая авторизацию через Twitch, вы подтверждаете, что вам исполнилось 13 лет, и соглашаетесь с{" "}
      ...
      <span className="opacity-70 mt-1.5 block">
        Несовершеннолетние используют сервис под надзором родителя или законного представителя.
      </span>
    </div>
  );
}
