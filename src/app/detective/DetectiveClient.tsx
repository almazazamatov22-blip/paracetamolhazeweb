  ...
  ru: {
    ...
    article: {
      ...
      lead: [
        ...
        "Основные публичные сведения собраны из описаний Twitch и YouTube-канала[[bold:.]][[bold:.]][[bold:.]]",
      ],
    },
    tocTitle: "Содержание",
    tocHide: "скрыть",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "На YouTube канал подписан как HabarHub и привязан к адресу @VagabovDmitrii. Подробные личные данные (дата рождения, город, семья) в доступных описаниях не раскрываются[[bold:-]][[bold:-]][[bold:-]]",
        ],
      },
      {
        id: "platforms",
        ...
        paragraphs: [
          ...
          "YouTube используется как витрина и архив канала HabarHub. Оформление и текст на странице. согласуются с Twitch-профилем- тот же ник, тот же акцент на разговорах и вечерних включениях[[bold:.]][[bold:.]][[bold:.]]",
        ],
      },
      {
        id: "disappearance",
        ...
        paragraphs: [
          ...
          "После 21 мая 2026 аккаунты не дали нового поста в обычное время. Внутри кейса это считается моментом исчезновения: канал на месте, но автор на связь не выходит[[bold:.]][[bold:-]]",
        ],
      },
      {
        id: "investigation",
        ...
        paragraphs: [
          ...
          "Для проверки сравнивают интервалы активности и временные метки публикаций на Twitch, YouTube и в Telegram, с отдельным вниманием к регулярному слоту 19:00 МСК[[bold:.]][[bold:-]][[bold:.]][[bold:.]]",
        ],
      },
      {
        id: "community",
        ...
        paragraphs: [
          ...
          "Сообщество продолжает сверять архивы, таймкоды и редкие следы активности, пытаясь восстановить полную цепочку событий по минутам[[bold:.]][[bold:.]][[bold:-]][[bold:-]][[bold:.]][[bold:.]]",
        ],
      },
    ],
    call: {
