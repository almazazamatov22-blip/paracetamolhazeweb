  ...
  ru: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Зрители разделились на две группы часть считает исчезновение медийной паузой[[bold:.]] Часть настаивает, что последний эфир отличался по ритму и тону-обычных включений[[bold:.]] Внутри сообщества[[bold:-]]сохраняется активный сбор заметок[[bold:-]]по датам и времени[[bold:.]]",
          "Сообщество продолжает сверять архивы, таймкоды и редкие следы активности, пытаясь восстановить полную цепочку событий по минутам[[bold:.]]",
        ],
      },
    ],
    call: {
