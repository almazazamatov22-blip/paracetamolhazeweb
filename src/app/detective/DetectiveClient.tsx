    ...
    sections: [
      {
        ...
        paragraphs: [
          "В открытых профилях автор использует имя «Хабар»[[bold:-]] На Twitch профиль описан как канал с вечерними стримами, где совмещаются разговор, просмотры, реакции и игровые сессии[[bold:-]]",
          "На YouTube[[bold:-]] канал подписан как HabarHub и привязан к адресу @VagabovDmitrii[[bold:.]] Подробные личные данные (дата рождения, город, семья) в доступных описаниях не раскрываются[[bold:.]]",
        ],
      },
      {
        id: "platforms",
        title: "Платформы",
        paragraphs: [
          "По описанию Twitch канал работает как ежедневная живая площадка. Отдельно вынесены команды для чата и переходы к анонсам в Telegram, что указывает на привычный цикл: анонс, эфир, обсуждение после эфира[[bold:.]]",
          "YouTube используется как витрина и архив канала HabarHub. Оформление и текст на странице согласуются с Twitch-профилем: тот же ник, тот же акцент на разговорах и вечерних включениях[[bold:.]]",
        ],
      },
      {
        id: "disappearance",
        ...
        paragraphs: [
          "Сюжет досье фиксирует, что 21 мая 2026 года к 19:00 МСК ожидался обычный стрим. Запуск действительно появился, но эфир завершился без привычного финального блока и без сообщений о переносе следующего выхода[[bold:-]]",
          "После 21 мая 2026 аккаунты не дали нового поста в обычное время[[bold:.]] Внутри кейса это считается моментом исчезновения[[bold:-]] канал на месте, но автор на связь не выходит[[bold:.]]",
        ],
      },
      {
        id: "investigation",
        ...
        paragraphs: [
          "Внутри сценария рассматриваются две основные версии: автор пропал без объяснений или автора могли убить[[bold:.]] Вторая версия остается только гипотезой расследования и требует подтверждения цифровыми уликами[[bold:.]]",
      ...
      },
      {
        ...
        paragraphs: [
          "Зрители разделились на две группы[[bold:-]] часть[[bold:-]] считает исчезновение запланированной паузой, часть настаивает, что последний эфир отличался по ритму и тону от обычных включений[[bold:.]] Внутри сообщества сохраняется активный сбор заметок по датам и времени[[bold:.]]",
