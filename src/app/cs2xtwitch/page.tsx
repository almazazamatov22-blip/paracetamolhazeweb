        ...
        <section className="cs2-info-section animate-slide-up" aria-labelledby="geo-title">
          ...
          <div className="cs2-info-content">
            ...
            <article>
              ...
              <p>Всем стримерам Twitch, которые хотят повысить вовлеченность аудитории, создать новые способы монетизации через баллы канала или просто добавить элемент хаоса и веселья в свои матчи.</p>
            </article>
            <article>
              <h3>Требования</h3>
