  ...
  return (
    <main className="min-h-screen bg-background text-foreground py-16 px-4 sm:px-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-6 text-gray-300 leading-relaxed">
        ...
        <p>
          Собранные данные используются исключительно для обеспечения работоспособности сервиса (создание наград, отображение статистики, работа оверлеев). Для работы сервиса данные могут обрабатываться поставщиками инфраструктуры и интеграций, включая Twitch, хостинг, базу данных и подключённые системы аналитики. Точный перечень и сроки хранения должны быть заполнены владельцем проекта до публикации окончательной политики.
        </p>
