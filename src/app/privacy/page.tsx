  ...
  return (
    <main className="min-h-screen bg-background text-foreground py-16 px-4 sm:px-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-6 text-gray-300 leading-relaxed">
        ...
        <p>На сайте используется Google Analytics для получения статистики посещений и взаимодействий. Сервис может обрабатывать сведения о просмотренных страницах, событиях на сайте, приблизительном местоположении, типе устройства, браузере и источнике перехода. Эти сведения используются для анализа работы сайта и улучшения его функций.</p>
        <p className="mt-4">Google Analytics может использовать cookies и аналогичные технологии. Обработка данных осуществляется Google в соответствии с политикой конфиденциальности Google.</p>
        <p className="mt-4">Яндекс Метрика на дату последнего обновления не подключена. Перед её подключением настоящая Политика конфиденциальности будет обновлена.</p>
