...
- **Analytics**: Поддержано условное подключение базовых счётчиков через переменные окружения. Пользовательские события пока не реализованы.
